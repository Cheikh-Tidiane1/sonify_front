...
import { ReadSong, SongContent } from '../../models/song.model';
...
export class PlayerComponent {
  ...
  currentSong: SongContent | undefined = undefined;
  ...
  private onNextSong(): void {
    ...
    const newHowlInstance = new Howl({
      src: [
        `data:${this.currentSong.fileContentType};base64,${this.currentSong.files}`,
      ],
